...
function showSearch() {
    let rowData = document.getElementById("meals-container");
    ...
    searchContainer.innerHTML = `
        <div class="row py-4">
            <div class="col-md-6">
                <input onkeyup="searchByName(this.value)" class="form-control bg-transparent text-white searchByNameInput" type="text" placeholder="Search By Name">
            </div>
            <div class="col-md-6">
